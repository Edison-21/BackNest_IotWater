...
let AtStrategy = class AtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, consts_1.JWT_AT_NAME) {
    constructor(configService) {
        const atSecret = configService.get('AT_SECRET') ?? 'at-secret';
        super({
