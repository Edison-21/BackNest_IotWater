...
let RtStrategy = class RtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, consts_1.JWT_RT_NAME) {
    constructor(configService) {
        const rtSecret = configService.get('RT_SECRET') ?? 'rt-secret';
        super({
