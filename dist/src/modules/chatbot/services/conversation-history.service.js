...
let ConversationHistoryService = class ConversationHistoryService {
    constructor(conversationHistoryRepository) {
    ...
    async findOne(id) {
        ...
        if (!conversationHistory) {
            throw new common_1.NotFoundException(`Historial de conversación con ID ${id} no encontrado`);
        }
        return conversationHistory;
    }
};
exports.ConversationHistoryService = ConversationHistoryService;
exports.ConversationHistoryService = ConversationHistoryService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.ConversationHistoryEntity)),
