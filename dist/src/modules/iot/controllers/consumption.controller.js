...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todos los consumos' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un consumo por ID' }),
...
exports.ConsumptionController = ConsumptionController = __decorate([
    (0, swagger_1.ApiTags)('Consumos'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('consumptions'),
    __metadata("design:paramtypes", [services_1.ConsumptionService])
