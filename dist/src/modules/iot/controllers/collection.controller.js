...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todas las recaudaciones' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener una recaudación por ID' }),
...
exports.CollectionController = CollectionController = __decorate([
    (0, swagger_1.ApiTags)('Recaudaciones'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('collections'),
    __metadata("design:paramtypes", [services_1.CollectionService])
