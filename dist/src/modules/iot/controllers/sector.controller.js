...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todos los sectores' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un sector por ID' }),
...
exports.SectorController = SectorController = __decorate([
    (0, swagger_1.ApiTags)('Sectores'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('sectors'),
    __metadata("design:paramtypes", [services_1.SectorService])
], SectorController);
